...
(library Library_1
	...
	(symbolDef "ATMEGA328PB-MU" (originalName "ATMEGA328PB-MU")
		...
		(pin (pinNum 33) (pt 2000 mils 1700 mils) (rotation 270) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 2025 mils 1470 mils) (rotation 90]) (justify "Right") (textStyleRef "Normal"))
		))
	...
	(compDef "ATMEGA328PB-MU" (originalName "ATMEGA328PB-MU") (compHeader (numPins 33) (numParts 1) (refDesPrefix IC)
		...
		(compPin "14" (pinName "(__SS0__/OC1B/PTCXY) PB2") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "17" (pinName "PB5 (PTCXY/XCK1/SCK0)") (partNum 1) (symPinNum 24) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "33" (pinName "GND_3") (partNum 1) (symPinNum 25) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "32" (pinName "PD2 (PTCXY/INT0/OC3B/OC4B)") (partNum 1) (symPinNum 26) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "31" (pinName "PD1 (PTCXY/OC4A/TXD0)") (partNum 1) (symPinNum 27) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "30" (pinName "PD0 (PTCXY/OC3A/RXD0)") (partNum 1) (symPinNum 28) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "29" (pinName "PC6 (__RESET)") (partNum 1) (symPinNum 29) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "28" (pinName "PC5 (ADC5/PTCY/SCL0)") (partNum 1) (symPinNum 30) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "27" (pinName "PC4 (ADC4/PTCY/SDA0)") (partNum 1) (symPinNum 31) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "26" (pinName "PC3 (ADC3/PTCY)") (partNum 1) (symPinNum 32) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "25" (pinName "PC2 (ADC2/PTCY)") (partNum 1) (symPinNum 33) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://ww1.microchip.com/downloads/en/DeviceDoc/40001907A.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "ATMEGA328PB-MU.stp")
